...
output_dir = Path("/Users/aakashsuresh/fairness/blood_glucose_project/data/processed/nhanes_combined")
...
# Process each dataset and save to data/processed/nhanes_combined/
