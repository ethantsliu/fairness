...
acc_data = pd.read_csv("/Users/aakashsuresh/fairness/blood_glucose_project/data/processed/nhanes_combined/nhanes_combined_acc.csv")  # Accelerometry data
glu_data = pd.read_csv("/Users/aakashsuresh/fairness/blood_glucose_project/data/processed/nhanes_combined/nhanes_combined_glu.csv")  # Plasma fasting glucose
diet_data = pd.read_csv("/Users/aakashsuresh/fairness/blood_glucose_project/data/processed/nhanes_combined/filled_nhanes_combined_diet.csv")  # Diet data
